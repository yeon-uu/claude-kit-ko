...
|---|---|---|
| [blader/humanizer](https://github.com/blader/humanizer) | MIT | write-human — Draft→Audit→Revise 프로세스, 패턴 분류 체계 |
...
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | MIT | design-layout — 타입 스케일·간격·대비 수치 규칙 |
| [jamditis/claude-skills-journalism](https://github.com/jamditis/claude-skills-journalism) | MIT | research-cited — 주장 추출, 증거 강도표, 반대 증거 의무 탐색 |
| [daymade/claude-code-skills](https://github.com/daymade/claude-code-skills) | MIT | research-cited — 출처 등급, [unverified]·AS_OF 마킹 |
| [Paramchoudhary/ResumeSkills](https://github.com/Paramchoudhary/ResumeSkills) | MIT | experience-block, jd-fit — X-Y-Z 공식, 6대 지표, 요구사항 3분류·가중 점수 |
| [santifer/career-ops](https://github.com/santifer/career-ops) | MIT | jd-fit — 요구사항↔증거 매핑 표, 파일 기반 트래커 |
| [varunr89/resume-tailoring-skill](https://github.com/varunr89/resume-tailoring-skill) | MIT | jd-fit — 발굴 인터뷰, 사실 보존 원칙 |
| [ARPeeketi/claude-resume-kit](https://github.com/ARPeeketi/claude-resume-kit) | MIT | experience-block — 수치 출처 플래그(provenance) 아이디어 |
| [Julia Evans — Brag Documents](https://jvns.ca/blog/brag-documents/) | 블로그(개념 참고) | experience-block — 마일스톤 기록 습관, "정확히 그만큼만" 원칙 |

## 라이선스 관계

이 키트는 MIT로 배포된다. 위 출처는 전부 MIT 또는 Apache-2.0(허용적 라이선스)이며, 방법·개념만 차용하고 원문을 복제하지 않았으므로 재배포·수정·상업 이용에 제약이 없다. 저작권은 표현을 보호하며 방법·절차·체계는 보호하지 않는다(대한민국 저작권법 제2조·미국 17 U.S.C. §102(b)).

혹시 본인 저작물이 부적절하게 반영됐다고 판단하는 저자는 이슈로 알려주면 즉시 반영한다.
